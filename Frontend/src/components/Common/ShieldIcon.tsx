...
const ShieldIcon: React.FC<ShieldIconProps> = ({ size = 24, ...props }) => {
    return (
        <svg
            width={size}
            height={size}
